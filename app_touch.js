...
// Shared input handler for mouse and touch
function handleInput(x, y) {
  const frequency = 260 + (x / window.innerWidth) * (maxFreq - 260);
  const volume = maxVol - (y / window.innerHeight) * maxVol;
...
// Add touchstart for initialization
window.addEventListener('click', init);
